...
described by 41 molecular descriptors, many of them skewed counts, labelled as readily biodegradable or not. We will
...
On QSAR biodegradation it does not: a plain linear model trained on the 500 labelled molecules is far ahead.
...
*drifts down* while the synthetic loss keeps improving. The longer the model specialises to the prior, the worse it fits the
