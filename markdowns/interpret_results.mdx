...
cookbookTags:
- interpretability
colab_url: https://colab.research.google.com/github/PriorLabs/prior-cookbook/blob/main/notebooks/interpret_results.ipynb
---
{/* cookbook-colab:start process_markdown.py */}
<div className="cookbook-colab">
  <a href="https://colab.research.google.com/github/PriorLabs/prior-cookbook/blob/main/notebooks/interpret_results.ipynb" className="cookbook-colab-button" target="_blank" rel="noopener noreferrer">
