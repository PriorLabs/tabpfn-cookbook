...
![Per-policy uncertainty: the whole distribution, not just a number](https://raw.githubusercontent.com/PriorLabs/tabpfn-cookbook/main/visuals/insurance_claim_modeling/plot-02.png)
