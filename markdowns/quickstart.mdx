...
description: Classification and regression with TabPFN.
icon: bolt
cookbookTags:
- api
authors:
...
```console
Mean Squared Error (MSE): 2644.03219611575
Mean Absolute Error (MAE): 40.70198539838399
R-squared (R^2): 0.5405885672117363
```
...
```console
Local ROC AUC: 0.804145349599895
```
