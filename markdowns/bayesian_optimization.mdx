...
- On Michalewicz-2 with 50 evaluations, TabPFN-EI gets within `1e-3` of the optimum on four of the five repeats and within `0.02` on the fifth (mean gap 0.0045, median 0.0004). GP-LogEI ends at a mean gap of 0.43 and random search at 0.70. TabPFN is ahead of the GP on every repeat, by a factor between 20 and 2000.
