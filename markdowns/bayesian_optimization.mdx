...
```python
!pip install "tabpfn-extensions[bayesian-optimization] @ git+https://github.com/PriorLabs/tabpfn-extensions.git"
```

```python
# bayesian_optimization extra is on GitHub main, not yet on the PyPI 0.4.x wheels.
!pip install -q -U "tabpfn>=8.1.0" "tqdm>=4.63.0,<=4.67.3" matplotlib
```
