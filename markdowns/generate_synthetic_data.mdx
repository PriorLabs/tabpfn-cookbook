---
title: Generate Synthetic Data with TabPFN
description: Learn how to generate synthetic data from your data
icon: plus
cookbookTags:
- extensions
authors:
...
*Look-alike tables from a foundation model, in seconds.*
