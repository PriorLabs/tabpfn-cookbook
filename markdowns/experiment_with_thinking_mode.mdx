...
- thinking mode
- api
colab_url: https://colab.research.google.com/github/PriorLabs/prior-cookbook/blob/main/notebooks/experiment_with_thinking_mode.ipynb
---
{/* cookbook-colab:start process_markdown.py */}
<div className="cookbook-colab">
  <a href="https://colab.research.google.com/github/PriorLabs/prior-cookbook/blob/main/notebooks/experiment_with_thinking_mode.ipynb" className="cookbook-colab-button" target="_blank" rel="noopener noreferrer">
...
![NATICUSdroid results](https://raw.githubusercontent.com/PriorLabs/prior-cookbook/main/visuals/experiment_with_thinking_mode/naticus-results.png)
...
![In-vehicle coupon results](https://raw.githubusercontent.com/PriorLabs/prior-cookbook/main/visuals/experiment_with_thinking_mode/coupon-results.png)
