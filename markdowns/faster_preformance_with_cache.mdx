...
cookbookTags:
- performance
colab_url: https://colab.research.google.com/github/PriorLabs/prior-cookbook/blob/main/notebooks/faster_preformance_with_cache.ipynb
---
{/* cookbook-colab:start process_markdown.py */}
<div className="cookbook-colab">
  <a href="https://colab.research.google.com/github/PriorLabs/prior-cookbook/blob/main/notebooks/faster_preformance_with_cache.ipynb" className="cookbook-colab-button" target="_blank" rel="noopener noreferrer">
