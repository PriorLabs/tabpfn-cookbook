...
The client documents [`average_precision`](https://github.com/PriorLabs/tabpfn-client/blob/v0.6.0/src/tabpfn_client/estimator.py#L292-L312) as a supported binary-classification thinking objective.
