...
This dataset was selected after exploratory comparisons on eight candidate datasets, including inspection of three candidates' test results. These scores illustrate a favorable example; they are not an unbiased estimate of performance across datasets.
...
TabPFN 3.5 gives better probability predictions than v3 in this example, with little additional gain from thinking. The small test set and test-informed dataset selection make these exploratory results.
